      ...
      <nav className={cn(
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-between h-16">
            ...
            >
              <div className={cn(
                "font-bold whitespace-nowrap shrink-0 text-base sm:text-lg md:text-xl xl:text-2xl",
                ...
                <span className={isHome ? "text-white" : "text-amber-900"}>, DRINK, PLAY CHEYENNE</span>
              </div>
            </Link>
      ...
      <footer className="bg-gradient-to-b from-amber-950 to-stone-950 text-amber-200 py-12 border-t-4 border-amber-800">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="mt-8 pt-8 border-t-2 border-amber-900 text-center text-sm">
            <p>© {new Date().getFullYear()} Eat, Drink, Play Cheyenne. Made with ❤️ in Wyoming</p>
          </div>
        </div>
      </footer>
    </div>
